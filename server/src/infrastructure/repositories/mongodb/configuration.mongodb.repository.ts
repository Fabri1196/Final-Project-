...
const password = 'kGuxHQLFpccF3HrD';
const dbname = 'Pharmacy'
const MONGO_URL = `mongodb+srv://fabripeirano:kGuxHQLFpccF3HrD@cluster0.ku8dczo.mongodb.net/Pharmacy?retryWrites=true&w=majority`;
